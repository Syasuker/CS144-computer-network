...
tests/CMakeFiles/byte_stream_stress_test_sanitized.dir/byte_stream_stress_test.cc.o: /tmp/minnow-main/tests/byte_stream_stress_test.cc
tests/CMakeFiles/byte_stream_stress_test_sanitized.dir/byte_stream_stress_test.cc.o: tests/CMakeFiles/byte_stream_stress_test_sanitized.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/minnow-main/cmake-build-debug-remote-host/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/byte_stream_stress_test_sanitized.dir/byte_stream_stress_test.cc.o"
	cd /tmp/minnow-main/cmake-build-debug-remote-host/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT tests/CMakeFiles/byte_stream_stress_test_sanitized.dir/byte_stream_stress_test.cc.o -MF CMakeFiles/byte_stream_stress_test_sanitized.dir/byte_stream_stress_test.cc.o.d -o CMakeFiles/byte_stream_stress_test_sanitized.dir/byte_stream_stress_test.cc.o -c /tmp/minnow-main/tests/byte_stream_stress_test.cc
...
tests/CMakeFiles/byte_stream_stress_test_sanitized.dir/byte_stream_stress_test.cc.i: cmake_force
	...
	cd /tmp/minnow-main/cmake-build-debug-remote-host/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/minnow-main/tests/byte_stream_stress_test.cc > CMakeFiles/byte_stream_stress_test_sanitized.dir/byte_stream_stress_test.cc.i
...
tests/CMakeFiles/byte_stream_stress_test_sanitized.dir/byte_stream_stress_test.cc.s: cmake_force
	...
	cd /tmp/minnow-main/cmake-build-debug-remote-host/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/minnow-main/tests/byte_stream_stress_test.cc -o CMakeFiles/byte_stream_stress_test_sanitized.dir/byte_stream_stress_test.cc.s
...
tests/byte_stream_stress_test_sanitized: tests/CMakeFiles/byte_stream_stress_test_sanitized.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/minnow-main/cmake-build-debug-remote-host/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable byte_stream_stress_test_sanitized"
	cd /tmp/minnow-main/cmake-build-debug-remote-host/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/byte_stream_stress_test_sanitized.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/byte_stream_stress_test_sanitized.dir/clean:
	cd /tmp/minnow-main/cmake-build-debug-remote-host/tests && $(CMAKE_COMMAND) -P CMakeFiles/byte_stream_stress_test_sanitized.dir/cmake_clean.cmake
